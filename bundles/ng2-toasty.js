...
System.registerDynamic("index", ["@angular/core", "@angular/common", "./src/toasty.component", "./src/toast.component", "./src/toasty.service"], true, function ($__require, exports, module) {
    // Copyright (C) 2016 Sergey Akopkokhyants
    // This project is licensed under the terms of the MIT license.
    // https://github.com/akserg/ng2-toasty
    'use strict';
    ...
    var ToastyModule = function () {
        ...
        ToastyModule = __decorate([core_1.NgModule({
            ...
            exports: [toasty_component_1.ToastyComponent, toasty_service_1.ToastyConfig, toasty_service_1.ToastyService]
